...
When('I create a {string} error', function (this: ErrorHandlingWorld, errorType: string) {
  switch (errorType) {
    case 'notFound':
...
Then('the error should be an instance of AppError', function (this: ErrorHandlingWorld) {
...
Then('the error code should be {string}', function (this: ErrorHandlingWorld, errorCode: string) {
...
Then('the error should have status code {int}', function (this: ErrorHandlingWorld, statusCode: number) {
  expect(this.error!.statusCode).to.equal(statusCode)
})

Then('the error meta should contain field errors', function (this: ErrorHandlingWorld) {
...
Then('the JSON should have property {string}', function (this: ErrorHandlingWorld, property: string) {
